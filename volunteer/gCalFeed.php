...
require_once (DB_TABLES . 'volCalendarRS.php');

require_once('classes' . DS . 'cEventClass.php');
require_once(CLASSES . "shellEvent_Class.php");
require_once (CLASSES . 'UserCategories.php');
require_once (CLASSES . 'emailClass.php');
require_once (CLASSES . 'VolCal.php');
