...
class Login {
    ...
    public static function initializeSession($configFileName) {
        ...
        $ssn->siteName = $config->getString('site','Site_Name', '');
        ...
        $ssn->StudentSG = $config->getBool('site', 'StudentSG', FALSE);
        ...
        if (isset($post["btnLogn"])) {
            ...
            if (isset($post["txtUname"])) {
                ...
                if (strlen($this->userName) > 50) {
                    $this->validateMsg .= "User Name is too long.  ";
            ...
            if (isset($post["challenge"])) {
                ...
                if (strlen($password) > 50) {
                    $this->validateMsg .= "Password encoding error.";
                } else if ($password == "") {
            ...
            if ($this->validateMsg == "") {
                ...
                if ($u->_checkLogin($dbh, $this->userName, $password, false) === FALSE) {
                    $this->validateMsg = "Bad User Name or Password. ";
                }
            }
        }
...
<table><tr>
    ...
    <th style='text-align:right;'>User Name: </th><td><input type='text' size ='15' name='txtUname' id='txtUname' value='" . $this->userName . "'  /></td>
</tr><tr>
    <th style='text-align:right;'>Password: </th><td><input type='password' size='15' name='txtPW' id='txtPW' value=''  />
