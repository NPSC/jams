...
class NameDemogRS extends TableRS {
    ...
    public $Timestamp;  // timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
      ...
      function __construct($TableName = "name_demog") {
        ...
        $this->idName = new DB_Field("idName", 0, new DbIntSanitizer());
        $this->Newsletter = new DB_Field("Newsletter", 0, new DbIntSanitizer());
...
class Name_GuestRS extends TableRS {
    ...
    public $idPatient_Relationship;  // int(11) NOT NULL DEFAULT '0',
    ...
    function __construct($TableName = "name_guest") {
        ...
        $this->idPatient_Relationship = new DB_Field("idPatient_Relationship", 0, new DbIntSanitizer(), TRUE, TRUE);
        $this->Relationship_Code = new DB_Field("Relationship_Code", "", new DbStrSanitizer(5));
