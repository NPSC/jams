...
class Address extends ContactPoint{
     ...
     * @return string
     */
    public function createPanelMarkup($addrIndex, NameAddressRS $adrRow, $showBadAddrCkBox = FALSE, $idPrefix = "", $class = "", $includeCounty = FALSE) {
        ...
        $table->addBodyTr(HTMLTable::makeTd('State', array('class'=>'tdlabel', 'title'=>'Select State or Province'))
                . HTMLTable::makeTd(
                        // State
                        HTMLSelector::generateMarkup('', $stAttr)

                        // Zip
                        . HTMLInput::generateMarkup('Zip', array('type'=>'button', 'data-hhkprefix'=>$idPrefix, 'data-hhkindex'=>$addrIndex, 'class'=>'hhk-zipsearch'))
                        . HTMLInput::generateMarkup($adrRow->Postal_Code->getStoredVal(), $zipAttr)
                 ));
        ...
        return $table->generateMarkup(array('class'=>$badAddrClass));
    ...
    public function createMarkup($inputClass = '', $showBadAddrCkBox = TRUE, $includeCounty = FALSE) {
        ...
        foreach ($orderd as $addrIndex) {
            ...
            $table = $this->createPanelMarkup($addrIndex, $this->rSs[$addrIndex], $showBadAddrCkBox, '', '', $includeCounty);
//
