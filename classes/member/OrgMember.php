...
class OrgMember extends Member {
    ...
    public function createMarkupTable() {
        ...
        $table->addHeaderTr(
                ...
                . HTMLContainer::generateMarkup('th', 'Organizationi Name')
    ...
    public function createRelationsTabs(array $rel, $page = "NameEdit.php", \iStudent $student = null) {
        ...
        $ul = HTMLContainer::generateMarkup('ul',
            ...
            .(is_null($student) === FALSE ? HTMLContainer::generateMarkup('li', HTMLContainer::generateMarkup('a', 'Student', array('href'=>'#stu'))) : '')
            );

        $relDiv = HTMLContainer::generateMarkup('div', $relTab, array('id'=>'empl', 'class'=>'ui-tabs-hide'));

        return $ul . $relDiv . $stuDiv;
    }
